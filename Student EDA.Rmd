...
output_file <- "~/Desktop/PISA_Merged_Cleaned.csv"
...
Load the data file
```{r}
data <- read.csv("PISA_Merged_Cleaned.csv", stringsAsFactors = TRUE)
summary(data)
str(data)
colnames(data)
```
...
categorical_vars <- c("ST004D01T", "ST005Q01TA", "ST007Q01TA", "HISCED", "ST011Q04TA",
                      "ST011Q06TA", "ST012Q09NA", "EFFORT1", "IMMIG", "LANGN", "ST034Q06TA",
...
```{r}
numeric_vars <- c( "PV1READ","PV1SCIE", "ESCS", "AGE", "COMPETE", "GFOFAIL")
data <- data %>%
